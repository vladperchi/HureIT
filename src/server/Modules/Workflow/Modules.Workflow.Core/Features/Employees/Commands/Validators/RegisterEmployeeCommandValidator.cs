// --------------------------------------------------------------------------------------------------
// <copyright file="RegisterEmployeeCommandValidator.cs" company="HureIT">
...
namespace HureIT.Modules.Workflow.Core.Features.Employees.Commands.Validators
{
    public class RegisterEmployeeCommandValidator : AbstractValidator<RegisterEmployeeCommand>
    {
        public RegisterEmployeeCommandValidator(
            ...
            IStringLocalizer<RegisterEmployeeCommandValidator> localizer)
        {
            ...
            RuleFor(x => x.Email).Cascade(CascadeMode.Stop)
               ...
               .MustAsync(async (email, _) => !await employeeService.IsEmailUniqueAsync(email))
