// --------------------------------------------------------------------------------------------------
// <copyright file="RoleClaimUpdatedEvent.cs" company="HureIT">
...
namespace HureIT.Modules.Identity.Core.Features.RoleClaims.Events
{
    public class RoleClaimUpdatedEvent : Event
    {
        ...
        public RoleClaimUpdatedEvent(HureRoleClaim roleClaim)
        {
            Id = roleClaim.Id;
            ...
            EventDescription = $"Updated RoleClaim:{roleClaim.ClaimValue}:::RoleId:{roleClaim.RoleId}:::Id:{roleClaim.Id}";
        }
    }
}