// --------------------------------------------------------------------------------------------------
// <copyright file="TokenService.cs" company="HureIT">
...
namespace HureIT.Modules.Identity.Infrastructure.Services
{
    public class TokenService : ITokenService
    {
        ...
        private async Task<IResult<TokenUserResponse>> GenerateTokensAndUpdateAsync(HureUser user, string ipAddress)
        {
        ...
        private async Task<string> GenerateJwtAsync(HureUser user, string ipAddress) =>
            GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user, ipAddress));

        private async Task<IEnumerable<Claim>> GetClaimsAsync(HureUser user, string ipAddress)
        {
