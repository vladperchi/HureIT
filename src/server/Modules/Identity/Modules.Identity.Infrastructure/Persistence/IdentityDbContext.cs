// --------------------------------------------------------------------------------------------------
// <copyright file="IdentityDbContext.cs" company="HureIT">
...
{
    public sealed class IdentityDbContext : IdentityDbContext<HureUser, HureRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, HureRoleClaim, IdentityUserToken<string>>,
        IIdentityDbContext,
        IModuleDbContext
    {
