// --------------------------------------------------------------------------------------------------
// <copyright file="PaginatedFilterValidator.cs" company="HureIT">
...
using HureIT.Shared.Core.Interfaces.Validators;
using HureIT.Shared.DTO.Filters;
using Microsoft.Extensions.Localization;

namespace HureIT.Shared.Core.Features.Queries.Validators
{
