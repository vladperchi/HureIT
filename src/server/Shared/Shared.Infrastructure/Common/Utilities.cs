// --------------------------------------------------------------------------------------------------
// <copyright file="Utilities.cs" company="HureIT">
...
namespace HureIT.Shared.Infrastructure.Common
{
    public static class Utilities
    {
        ...
        {
            const string chars = StringKeys.AlphaNumeric;
            return Task.FromResult(new string(Enumerable
                .Repeat($"{letter}-{chars}-{StringKeys.AppName.ToUpper()}", length)
